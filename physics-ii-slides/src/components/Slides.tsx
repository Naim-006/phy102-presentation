    ...
    >
      <div className="flex items-center justify-center gap-4 mb-8">
        ...
        <div className="text-left">
            ...
            <div className="text-xl font-bold tracking-widest text-white uppercase">Physics II</div>
        </div>
      </div>
      ...
      <div className="grid grid-cols-2 gap-12 text-left bg-gray-900 border border-white/5 rounded-[40px] p-10">
        <div>
          <h3 className="text-physics-accent text-[10px] font-mono uppercase tracking-[0.3em] mb-4">Instructor</h3>
          <p className="text-white font-bold text-lg">Sumaiya Alam Chowdhury</p>
          <p className="text-xs text-gray-500 uppercase tracking-widest mt-1">Lecturer, Dept. of CSE, DIU</p>
        </div>
        <div>
      ...
      <div className="flex gap-12 items-center h-full">
        <div className="flex-1 space-y-6">
          ...
          <p className="text-lg text-gray-400">
            It acts like a stream of energy balls called <span className="text-white font-bold">Photons</span>. One photon kicks one electron!
          </p>
          <div className="p-6 bg-gray-900 border border-white/5 rounded-[30px]">
            ...
            <div className="space-y-4">
                <div className="flex items-center gap-4">
                  ...
                  <p className="text-gray-300 text-sm">Solar energy starts exactly like this.</p>
                </div>
                <div className="flex items-center gap-4">
                  <div className="w-10 h-10 rounded-xl bg-gray-800 flex items-center justify-center">
                    <Lightbulb className="w-5 h-5 text-physics-accent" />
                  </div>
                  <p className="text-gray-300 text-sm">Street lights "sense" night using this theory.</p>
                </div>
            </div>
          </div>
        </div>
        
        <div className="flex-1 rounded-[40px] border border-white/10 bg-black p-8 flex items-center justify-center relative overflow-hidden h-[450px]">
  ...
  return (
    <SlideLayout title="The Energy Barriers" subtitle="Frequency & Work Function">
      <div className="grid grid-cols-2 gap-12 h-full items-center">
        <div className="space-y-8">
          <section className="bg-gray-900/40 p-8 rounded-2xl border border-white/5">
            <h3 className="text-2xl font-bold text-white mb-2 italic">1. Threshold Frequency (<Latex formula="\nu_0" />)</h3>
          ...
          <section className="bg-gray-900/40 p-8 rounded-2xl border border-white/5">
            <h3 className="text-2xl font-bold text-white mb-2 italic">2. Work Function (<Latex formula="\Phi" />)</h3>
            <p className="text-gray-400 leading-relaxed">
        ...
        <SlideLayout title="Einstein’s Magic Formula" subtitle="Very Simple Energy Math">
            <div className="mt-8 grid grid-cols-2 gap-12 items-center h-full">
                ...
                <div className="bg-physics-accent/5 p-12 rounded-[50px] border-4 border-dashed border-physics-accent/20 text-center">
                    <p className="text-gray-500 uppercase text-xs font-mono mb-4">Final Highlighted Form</p>
                    <div className="text-4xl font-bold p-8 bg-black rounded-3xl shadow-[0_0_30px_rgba(0,212,255,0.15)]">
    ...
    <div className="grid grid-cols-3 gap-8 mt-12 h-[400px]">
       {[
         ...
         >
           ...
           <div className="h-full border border-white/10 rounded-3xl p-8 flex flex-col items-center justify-center text-center">
              <type.icon className="w-16 h-16 text-physics-accent mb-6" />
              <h3 className="text-2xl font-bold text-white mb-4 uppercase italic tracking-tighter">{type.title}</h3>
   ...
   return (
      <SlideLayout title="What is the Compton Effect?" subtitle="Bouncing Light">
         <div className="flex gap-12 items-center h-full">
            ...
            <p className="text-lg text-gray-400">
               This proves that light acts like a <span className="text-white font-bold">Small Ball (Particle)</span> that can hit things and bounce off!
            </p>
            <div className="grid grid-cols-2 gap-4">
               <div className="bg-gray-800/80 p-6 rounded-2xl border border-white/10">
                  <div className="text-xs text-physics-accent font-bold mb-1 uppercase tracking-widest">Wavelength Change</div>
                  <p className="text-white text-xl">Gets <span className="text-red-400 font-black">LONGER</span></p>
                  <p className="text-[10px] text-gray-500 mt-2">Less Energy Left</p>
               </div>
               <div className="bg-gray-800/80 p-6 rounded-2xl border border-white/10">
                  <div className="text-xs text-physics-accent font-bold mb-1 uppercase tracking-widest">Frequency Change</div>
                  <p className="text-white text-xl">Gets <span className="text-blue-400 font-black">LOWER</span></p>
                  <p className="text-[10px] text-gray-500 mt-2">Energy transferred to electron</p>
               </div>
            </div>
            </div>
            
            <div className="flex-1 rounded-[40px] border border-white/10 bg-black flex flex-col p-12 relative overflow-hidden h-[450px]">
               ...
               <div className="mt-8 pt-6 border-t border-white/5 text-center">
                  <p className="text-[10px] text-gray-500 italic">Notice: Photon loses energy and changes wavelength.</p>
               </div>
            </div>
         </div>
      </SlideLayout>
...
export const Slide8_Assumptions = () => (
  <SlideLayout title="The Rules of the Game" subtitle="Basic Assumptions">
    <div className="grid grid-cols-2 gap-12 mt-8">
      ...
      <div className="bg-gray-900/50 p-8 rounded-3xl border border-white/5 space-y-8 flex flex-col justify-center">
         ...
         <div className="space-y-4">
            <div className="flex items-center justify-between p-4 bg-black/40 rounded-xl">
               <span className="text-gray-400">Energy In = Energy Out</span>
            </div>
            <div className="flex items-center justify-between p-4 bg-black/40 rounded-xl">
               <span className="text-gray-400">Momentum (Push) stays the same</span>
            </div>
         </div>
      </div>
    </div>
...
export const Slide9_Derivation = () => {
    return (
        <SlideLayout title="The Compton Formula" subtitle="Calculating the Change">
            <div className="flex h-full items-center justify-center">
                <div className="max-w-3xl w-full">
                    <div className="bg-physics-accent/10 p-12 border-2 border-physics-accent/40 rounded-[60px] text-center shadow-[0_0_50px_rgba(0,212,255,0.1)]">
                        <p className="text-gray-400 font-mono text-sm uppercase mb-6 tracking-[0.5em]">The Change in Wavelength</p>
                        <div className="text-6xl py-8 bg-black/60 rounded-3xl mb-8 border border-white/5">
                        ...
                        <div className="grid grid-cols-2 gap-8 text-left">
                            <div className="p-6 bg-gray-900/50 rounded-2xl border border-white/5">
                                ...
                                <p className="text-white text-xl font-mono">0.00243 nm</p>
                                <p className="text-[10px] text-gray-500 mt-1 italic">(Called the Compton Wavelength)</p>
                            </div>
                            <div className="p-6 bg-gray-900/50 rounded-2xl border border-white/5">
                                <h5 className="text-physics-accent text-xs font-bold uppercase mb-2 tracking-widest">Angle Effect</h5>
                                <p className="text-white">Depends on the Angle (<Latex formula="\phi" />)</p>
                                <p className="text-xs text-gray-500 mt-1 italic">The more it bounces, the bigger the shift!</p>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    return (
        <SlideLayout title="Science Graphs" subtitle="Checking the Data">
            <div className="flex h-full gap-8">
                    ...
                    {graphConfig.map((g, i) => (
                        <button
                            ...
                            className={cn(
                                ...
                                graphType === i ? "bg-physics-accent border-physics-accent text-black" : "bg-gray-900 border-white/5 text-gray-400"
                            )}
                        >
                            {g.title}
                        </button>
                ...
                <div className="flex-1 bg-gray-900/20 rounded-[40px] border border-white/5 p-12 flex flex-col">
                    <div className="mb-8">
                        <h4 className="text-3xl font-bold text-white mb-2 italic">{graphConfig[graphType].title}</h4>
                        <p className="text-gray-500 italic text-sm">{graphConfig[graphType].subtitle}</p>
                    </div>
                    ...
                    <div className="mt-8 flex gap-8 justify-center">
                         {graphConfig[graphType].labels.map((l, idx) => (
                             <div key={l} className="flex items-center gap-2">
                                 ...
                                 <span className="text-[10px] uppercase font-mono text-gray-500">{l}</span>
                             </div>
                         ))}
                    </div>
                </div>
    ...
    <SlideLayout title="Solving Problems" subtitle="Simple Examples">
        <div className="grid grid-cols-2 gap-8 mt-4 h-full">
            <div className="space-y-6 flex flex-col">
                <div className="flex-1 p-8 bg-gray-900 border border-white/5 rounded-3xl relative">
                    <div className="absolute top-4 right-6 text-[10px] font-mono text-physics-accent uppercase">Example 1</div>
                    <h4 className="text-white font-bold mb-4">Find the Start Frequency (Threshold)</h4>
                    <div className="space-y-4 text-sm text-gray-400">
                        <p>Work Function (<Latex formula="\Phi" />) = 1.85 eV</p>
                        <div className="p-4 bg-black/40 rounded-xl font-mono border border-white/5">
                ...
                <div className="flex-1 p-8 bg-gray-900 border border-white/5 rounded-3xl relative">
                    ...
                    <h4 className="text-white font-bold mb-4">Will electrons come out?</h4>
                    <div className="space-y-4 text-sm text-gray-400">
            ...
            <div className="flex flex-col">
                <div className="flex-1 p-12 bg-physics-accent/5 rounded-[50px] border border-physics-accent/20 relative">
                    ...
                    <h3 className="text-3xl font-black text-white mb-6">Compton shift</h3>
                    <p className="text-gray-400 mb-8">
                       What is the shift when light bounces at <Latex formula="90^\circ" />?
                    </p>
                    <div className="space-y-4 p-8 bg-black/50 rounded-3xl border border-white/5">
                        <div className="flex items-center gap-4">
                        ...
                        <div className="pt-6 border-t border-white/5">
                            <div className="text-[10px] text-gray-500 mb-2 uppercase tracking-widest">Shift Result</div>
...
export const Slide13_ThankYou = () => (
    <div className="w-full h-full flex flex-col items-center justify-center relative overflow-hidden bg-physics-bg">
        ...
        <motion.div
            ...
            className="z-10 text-center"
        >
            <h1 className="text-[12rem] font-black text-white italic tracking-tighter leading-none mb-4">
            ...
            <div className="flex gap-24 text-left justify-center">
                ...
                <div>
                   ...
                   <div className="text-sm text-gray-400 font-mono">
                      <p className="text-white font-bold">PHY 102: Physics II</p>
